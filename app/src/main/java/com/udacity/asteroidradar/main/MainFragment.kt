...
class MainFragment : Fragment() {
    ...
    private val asteroidAdapter = MainFragmentAdapter(MainFragmentAdapter.AsteroidListener { asteroid ->
    ...
    override fun onCreateView(
        ...
        viewModel.navigateToDetailAsteroid.observe(viewLifecycleOwner, Observer { it ->
            if (it != null) {
